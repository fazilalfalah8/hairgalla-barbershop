...
<body>
  ...
  <section id="hero-full">
    ...
    <div class="hero-content">
      ...
      <p class="hero-sub">Premium Barbershop — Pangkalan Kerinci</p>
    ...
    <div style="display:grid; grid-template-columns:1fr 1fr; gap:80px; align-items:center;">
      <div>
        ...
        <p style="font-size:14px; color:#888; font-family:Arial,sans-serif; line-height:1.9; margin-bottom:16px;">
          Hairgalla Barbershop hadir untuk pria yang menghargai penampilan dan kenyamanan. Didirikan tahun 2024 dengan visi memberikan pengalaman grooming premium di Pangkalan Kerinci.
        </p>
